...
export const DEFAULT_FACILITY_TYPES = [
  ...
  { key: "BORDER_LAND", label: "Chegara oldi yeri" },
  { key: "WORKSHOP_SAUSAGE", label: "Ishlab chiqarish sexi (kolbasa)" },
  { key: "WORKSHOP_COOKIE", label: "Ishlab chiqarish sexi (pechenye)" },
  { key: "POULTRY_MEAT", label: "Tovuqxona (go‘sht)" },
  { key: "POULTRY_EGG", label: "Tovuqxona (tuxum)" },
  { key: "TURKEY", label: "Kurkaxona" },
  { key: "COWSHED", label: "Molxona" },
  { key: "SHEEPFOLD", label: "Qo‘yxona" },
  { key: "AUX_LAND", label: "Yordamchi xo‘jalik yeri" },
];
